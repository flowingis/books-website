...
class prophpProdProjectContainer extends Container
{
  ...
  array (
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/MAMP/htdocs/sandbox/prophp',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'prophp',
            'kernel.cache_dir' => '/Applications/MAMP/htdocs/sandbox/prophp/cache/prod',
            'kernel.logs_dir' => '/Applications/MAMP/htdocs/sandbox/prophp/logs',
            'kernel.bundle_dirs' => array(
                'Application' => '/Applications/MAMP/htdocs/sandbox/prophp/../src/Application',
                'Bundle' => '/Applications/MAMP/htdocs/sandbox/prophp/../src/Bundle',
                'Symfony\\Framework' => '/Applications/MAMP/htdocs/sandbox/prophp/../src/vendor/Symfony/src/Symfony/Framework',
            ),
            'kernel.bundles' => array(
                ...
                5 => 'Application\\ProPhpBundle\\ProPhpBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'templating.loader.filesystem.path' => array(
                0 => '/Applications/MAMP/htdocs/sandbox/prophp/views/%bundle%/%controller%/%name%%format%.%renderer%',
                1 => '/Applications/MAMP/htdocs/sandbox/prophp/../src/Application/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%',
                2 => '/Applications/MAMP/htdocs/sandbox/prophp/../src/Bundle/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%',
                3 => '/Applications/MAMP/htdocs/sandbox/prophp/../src/vendor/Symfony/src/Symfony/Framework/%bundle%/Resources/views/%controller%/%name%%format%.%renderer%',
            ),
